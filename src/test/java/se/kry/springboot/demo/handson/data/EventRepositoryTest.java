...
class EventRepositoryTest {
  ...
  @Test
  void get_events() {
    var start = LocalDate.of(2001, Month.JANUARY, 1).atTime(LocalTime.MIDNIGHT).atZone(UTC);
  ...
  void save_event() {
    ...
    assertThat(event.getStart()).hasToString("2001-01-01T00:00Z[UTC]");
    assertThat(event.getEnd()).hasToString("2001-01-01T12:00Z[UTC]");
  }
}
